...
//filter in both directions
    vec4 horizontalFilter = kernelValues[2] + (2.0*kernelValues[5]) + kernelValues[8] - (kernelValues[0] + (2.0*kernelValues[3]) + kernelValues[6]);
...
//put all together
    ...
    //gl_FragColor.a = 1.0;
gl_FragData[0].rgb = sqrt((horizontalFilter.rgb * horizontalFilter.rgb) + (verticalFilter.rgb * verticalFilter.rgb));
gl_FragData[0].a = 1.0;
